...
function KeuanganContent({ kpiKeuangan, cashflowWeekly = [], topPengeluaran = [] }) {
    const cards = [
        ...
        { title: "Total Material Keluar", value: formatRupiah(kpiKeuangan.totalMaterialKeluar ?? 0), meta: "Jumlah nominal material yang keluar", icon: <TrendingUp size={18} />, tone: "down" },
        { title: "Sisa Material Keluar", value: formatRupiah(kpiKeuangan.sisaMaterialKeluar ?? 0), meta: "Nilai sisa material yang tersisa dalam rupiah", icon: <ClipboardList size={18} /> },
    ];
        ...
        <AuthenticatedLayout>
            ...
            <div className="space-y-5">
                ...
                {tab === "operasional" && canOperasional && (
                    <OperasionalContent kpiOperasional={props.kpiOperasional} rows={props.rows} monitoring={props.monitoring} stokGudang={props.stokGudang} />
                )}
